...
const newsData = [
    { id: 1, title: '5º andar em manutenção', content: 'Estamos em manutenção no 5º andar' },
    { id: 2, title: 'Manutenção preventiva agendada', content: 'Será realizada na próxima semana' },
    { id: 3, title: 'Modernização do sistema', content: 'Elevadores agora possuem tecnologia IoT e AI' },
    { id: 4, title: 'Redução no consumo de energia', content: 'Nova tecnologia economiza 35% de energia' },
    { id: 5, title: 'Elevador 3 voltou ao funcionamento', content: 'Reparo concluído após 5 dias' },
];
